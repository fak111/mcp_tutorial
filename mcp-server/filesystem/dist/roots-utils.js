...
export async function getValidRootDirectories(directories) {
    const validDirs = [];
...
export function isPathUnderRoot(targetPath, rootPaths) {
...
export function validatePathAgainstRoots(targetPath, rootPaths) {
